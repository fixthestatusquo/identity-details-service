...
function post(payload, identityUrl) {
    return __awaiter(this, void 0, void 0, function () {
        var url, req, resp;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = identityUrl + '/api/member/details';
                    req = new Request(url, {
                        method: "post",
...
function getMember(by, api) {
    return __awaiter(this, void 0, void 0, function () {
        var api_token, data, ret;
        return __generator(this, function (_a) {
            api_token = api.token;
            data = null;
            if (by.guid) {
            ...
            ret = post(data, api.url);
            ret = ret.then(function (x) {
...
function detailsToContact(details) {
    var c = {
